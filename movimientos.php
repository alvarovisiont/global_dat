	...
	<div class="container-fluid">
		<div class="col-md-12">
			<table class="table table-strepead table-hover" id="tabla">
				...
				<?php
					$crud->sql = "SELECT id, nombre, apellido, cedula, nac, telefono, email, direccion, fecha_nacimiento FROM estructuras WHERE id_movimiento = $_SESSION[id]";
					$crud->leer();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-modificar" action="grabar_movimientos.php" method="POST">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-agregar" action="grabar_movimientos.php" method="POST">
             <input type="hidden" name="accion" value="grabar_estructura">
             <input type="hidden" name="id_movimiento" value="<?php echo $_SESSION['id']; ?>">
