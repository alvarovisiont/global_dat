	...
	<div class="container-fluid">
		<div class="col-md-12">
			<table class="table table-strepead table-hover" id="tabla">
				...
				<?php
					$crud->sql = "SELECT id, nombre, apellido, cedula, nac, telefono, email, direccion, fecha_nacimiento, sexo, centro_votacion FROM estructuras WHERE id_juventud = $_SESSION[id]";
					$crud->leer();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-modificar" action="grabar_juventud.php" method="POST">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-agregar" action="grabar_juventud.php" method="POST">
             <input type="hidden" name="accion" value="grabar_estructura">
             <input type="hidden" name="id_juventud" value="<?php echo $_SESSION['id']; ?>">
        ...
        var chart;
            ...
            <?php 
                $crud->sql = "SELECT nombre, apellido, 
                                (SELECT count(*) from caracterizacion where id_juve_lider = estructuras.id) as total FROM estructuras WHERE id_juventud = $_SESSION[id]";
                $crud->leer();
                if(count($crud->filas) > 0)
                {
                    foreach ($crud->filas as $row) 
