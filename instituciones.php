	...
	<div class="container-fluid">
		<div class="col-md-12">
			<table class="table table-strepead table-hover" id="tabla">
				...
				<?php
					$crud->sql = "SELECT id, nombre, apellido, cedula, nac, telefono, email, direccion, fecha_nacimiento FROM estructuras WHERE id_institucion = $_SESSION[id]";
					$crud->leer();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-agregar" action="grabar_institucion.php" method="POST">
             <input type="hidden" name="accion" value="grabar_estructura">
             <input type="hidden" name="id_institucion" value="<?php echo $_SESSION['id']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header login-header">
             ...
             <form class="form-horizontal" id="form-modificar" action="grabar_institucion.php" method="POST">
